...
@org.hibernate.annotations.NamedQueries ({
	...
	query="FROM Employee WHERE lower(firstName) like :searchTerm OR lower(lastName) like :searchTerm OR lower(email) LIKE :searchTerm or lower(phoneNumber) like :searchTerm OR departmentId IN (:deptIDs)")
})
